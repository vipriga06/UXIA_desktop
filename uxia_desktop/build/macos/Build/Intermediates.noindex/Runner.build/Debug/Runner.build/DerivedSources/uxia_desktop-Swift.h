...
#ifndef UXIA_DESKTOP_SWIFT_H
#define UXIA_DESKTOP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="uxia_desktop",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC12uxia_desktop11AppDelegate")
...
SWIFT_CLASS("_TtC12uxia_desktop17MainFlutterWindow")
